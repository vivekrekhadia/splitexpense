  ...
  return (
    <div className="min-h-screen bg-gray-200 flex items-start justify-center md:items-center md:py-8">
      <div className="w-full md:w-[430px] bg-[#F7F8FA] min-h-screen md:min-h-0 md:rounded-[2.5rem] md:shadow-2xl md:overflow-hidden flex flex-col justify-center px-6 py-12">
        ...
        <h1 className="text-2xl font-semibold text-[#1A1A2E] mb-6 text-center">Create account</h1>
        ...
        <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              className="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#5BC5A7]"
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <a href="/login" className="text-[#5BC5A7] font-medium hover:underline">
            Sign in
          </a>
        </p>
      </div>
